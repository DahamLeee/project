...
module.exports = function(passport){
  ...
  const callbackURL = (process.env.NODE_ENV == 'production') ? 'https://desolate-gorge-45600.herokuapp.com//auth/facebook/callback' :
  'http://localhost:3000/auth/facebook/callback';

  passport.use(new FacebookStrategy({
    clientID : process.env.FBID || '312659525878255',
    clientSecret : process.env.FB_SECRET || '32616985e32c4b42546e31d90c67bb13',
